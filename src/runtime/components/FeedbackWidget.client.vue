...
import FeedbackWidgetWrapper from "#nuxt-feedback/components/FeedbackWidgetWrapper.ce.vue";
...
onMounted(() => {
  customElements.define("widget-wrapper-ce", WidgetWrapper);
  registerWidget();
});
